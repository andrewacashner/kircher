...
c1v = [ 
        ...
        [ --4
            ...
            [3, 2, 3, 4, 5, 4, 3, 4, 5, 5], -- CN last 5 missing
        ...
        [ --6
            ...
            [5, 6, 5, 4, 5, 4, 5, 6, 4, 3, 2, 3, 4], -- CN 5, *5, 5...
            [3, 4, 2, 1, 3, 1, 1, 1, 1],
            [8, 4, 5, 6, 3, 4, 4, 1, 4]
        ],
        [ -- 7
            [2, 3, 4, 5, 4, 5, 7, 6, 8, 6, 5], -- CN? 2, 3, 4, 5, 4, 5, 7, 6, *6, 6, 5
            [7, 1, 2, 1, 7, 2, 2, 3, 2, 7],
        ...
        [ --9
            ...
            [6, 6, 5, 4, 5, 4, 5, 6, 5, 4, 5, 6, 5, 6], -- CN *5, 6...
            [3, 4, 2, 1, 3, 1, 1, 1, 1],
            [6, 4, 5, 6, 3, 4, 3, 2, 1, 4]
        ]
    ]
